...
let me = {
  ...
  age: 25,
  greeter: function() {
    return `Hello! My is ${this.firstName} and i live in ${this.state}`;
  }
};
//////////////////PROBLEM 12////////////////////
...
// Code Here
var total = myNumbers.reduce((num1, num2) => num1 + num2);
//////////////////PROBLEM 17////////////////////
...
// Code Here
var myNumbersIndex = [];
myNumbers.forEach((red, blue) => myNumbersIndex.push(blue));
//////////////////PROBLEM 18////////////////////
...
// Code Here
var forTheLoveOfGeorge = notGeorge.map(mygeorge => "George");
//////////////////PROBLEM 19////////////////////
...
// Code Here
var totallyAwesome = people.reduce(
  (numbers, friends) => friends.awesomeLevel + numbers,
  0
);
